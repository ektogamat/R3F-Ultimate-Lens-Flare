...
const App = () => {
  ...
  return (
    <>
      <Head>
        <title>R3F Ultimate Lens Flare - Example</title>
        <meta name="description" content="R3F Ultimate Lens Flare - Example" />
      ...
      <Canvas
        ...
        camera={{ position: [8, 1, 10], near: 0.5, fov: isMobile ? 80 : 45 }}
      >
        <PerformanceMonitor
          onIncline={() => setDpr(1)}
